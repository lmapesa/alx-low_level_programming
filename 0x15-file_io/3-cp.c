 ...
 *
 * Return: Pointer 2 newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * main - Copies the contents of a file 2 another file.
 * @argc: No. of args supplied 2 the program.
 * @argv: An array of pointers 2 the arguments.
 *
 * Return: 0 on success.
 *
